 ...
 * @description: 有限次数的任务的日志(比如新手任务, 一个用户完成一次就不能再做第二次了)
 * @author: wangwei
 * @create: 2020-08-26 17:59
 **/
@Data
@TableName("finite_task_log")
public class FiniteTaskLogDO implements Serializable {

    private static final long serialVersionUID = -6110003192698675859L;
