...
import com.video.user.interceptor.AdminInterceptor;
import com.video.user.interceptor.ApiIntercepter;
...
public class InterceptorConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        adminInterceptorRegistration.excludePathPatterns("/api/v1/users/message/code");
        adminInterceptorRegistration.excludePathPatterns("/api/v1/users/loginPhone");
    }
